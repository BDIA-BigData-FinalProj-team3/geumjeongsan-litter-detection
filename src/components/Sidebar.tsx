import { Home, LayoutDashboard, Camera, UserX, TrendingUp, Clock, Trash2, Users, ChevronDown, ChevronRight, HeartPulse, FileText, AlertTriangle, Flame, Mountain } from 'lucide-react';
